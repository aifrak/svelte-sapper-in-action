...
describe('Category', () => {
  /*
    This will be set to the number of items that are added to the category inside the function that
    is passed to beforeEach
  */
  let itemCount = 0;
  ...
  /*
    The Category component requires this prop, but it won't be used in the test, so an empty
    object suffices.
  */
  const dnd = {};
